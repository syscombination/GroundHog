...
from groundhog.trainer.SGD_adadeltamrt_sc import SGD as SGD_adadeltamrt
from groundhog.mainLoop import MainLoop
from experiments.nmt import\
        RNNEncoderDecoder, Syscombination, prototype_state, get_batch_iterator, get_batch_iterator_syscombination
    ...
    def __call__(self):
        ...
        while sample_idx < self.state['n_examples']:
            ...
            for seq_idx in range(xs.shape[1]):
                ...
                y, h, oh= ys[:, seq_idx], hs[:, seq_idx, :], ohs[:, seq_idx, :]
                #print oh
                ...
                #print h_words
                self.model.get_samples(self.state['seqlen'] + 1, self.state['n_samples'], h[:,:])
                sample_idx += 1
